...
//  Replaces SharedOneEightyState and StateChangeObserver.
//
...
private let logger = Logger(subsystem: "com.danielbutler.OneEighty", category: "SharedStateStore")
...
final class SharedStateStore: StateStore {
    ...
    private init() {
        defaults = UserDefaults(suiteName: "group.com.danielbutler.OneEighty") ?? .standard
        startObserving()
    }
