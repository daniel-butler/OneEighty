...
#ifndef METRONOMEAPP_SWIFT_H
#define METRONOMEAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MetronomeApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIApplication;
SWIFT_CLASS("_TtC12MetronomeApp11AppDelegate")
@interface AppDelegate : NSObject <UIApplicationDelegate>
- (void)applicationWillTerminate:(UIApplication * _Nonnull)application;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC12MetronomeApp19PhoneSessionManager")
@interface PhoneSessionManager : NSObject
...
@class WCSession;
@class NSString;
@interface PhoneSessionManager (SWIFT_EXTENSION(MetronomeApp)) <WCSessionDelegate>
