...
#ifndef ONEEIGHTYWATCH_WATCH_APP_SWIFT_H
#define ONEEIGHTYWATCH_WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OneEightyWatch_Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC24OneEightyWatch_Watch_App19WatchSessionManager")
...
@class WCSession;
@class NSString;
@interface WatchSessionManager (SWIFT_EXTENSION(OneEightyWatch_Watch_App)) <WCSessionDelegate>
