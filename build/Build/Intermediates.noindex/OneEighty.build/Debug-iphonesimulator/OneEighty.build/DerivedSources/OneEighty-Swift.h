...
#ifndef ONEEIGHTY_SWIFT_H
#define ONEEIGHTY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OneEighty",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIApplication;
SWIFT_CLASS("_TtC9OneEighty11AppDelegate")
@interface AppDelegate : NSObject <UIApplicationDelegate>
- (void)applicationWillTerminate:(UIApplication * _Nonnull)application;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC9OneEighty19PhoneSessionManager")
...
@class WCSession;
@class NSString;
@interface PhoneSessionManager (SWIFT_EXTENSION(OneEighty)) <WCSessionDelegate>
